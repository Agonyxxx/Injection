...
$token = "MTI1OTYzNTU1NTQwMzA0Mjk0Nw.G2kfof.oX3AO71aMkdZVY14a-Pv9kp0k8XqNkiZExpV0E" # make sure your bot is in the same server as the webhook
$chan = "1260462768096804890" # make sure the bot AND webhook can access this channel
